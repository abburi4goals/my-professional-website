...
const TimelineItem = ({ years, title, company, description, skills }: TimelineItemProps) => {
  return (
    <div className="relative pl-8 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px before:bg-gray-200 dark:before:bg-gray-700">
      ...
      <div className="flex flex-wrap gap-2">
        {skills.map((skill, index) => (
          <Badge key={index} variant="secondary" className="bg-brand-50 text-brand-600 hover:bg-brand-100 dark:bg-gray-700 dark:text-brand-400 dark:hover:bg-gray-600">
            {skill}
          </Badge>
        ))}
      </div>
